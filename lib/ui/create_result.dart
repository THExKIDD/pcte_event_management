                      ...
                      child: ListTile(
                        ...
                        trailing: Container(
                          ...
                          child: PopupMenuButton<int>(
                            ...
                            onSelected: (value) => selectWinner(classModel, value),
                            itemBuilder: (context) => [
                              PopupMenuItem(value: 1, child: Text("🥇 1st Place")),
                              PopupMenuItem(value: 2, child: Text("🥈 2nd Place")),
                              PopupMenuItem(value: 3, child: Text("🥉 3rd Place")),
                            ],
                          ),
                        ),
                      ),
