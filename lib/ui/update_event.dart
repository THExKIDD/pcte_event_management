...
class _UpdateEventScreenState extends State<UpdateEventScreen> {
  ...
  Future<void> _fetchEventDetails() async {
    try {
      final response = await _dio.get('https://koshish-backend.vercel.app/api/event/${widget.eventId}');
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (points.isNotEmpty) {
            for (var point in points) {
              _pointsControllers.add(TextEditingController(text: point.toString()));
            }
          }
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          dropDownProvider.setSelectedValue("participationType", _initialParticipationType);
        });
      } else {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildDynamicFields("Rules", _rulesControllers, _addRuleField, _removeRuleField, minFields: 1),
              SizedBox(height: screenSize.height * 0.02),
              ...
              _buildDynamicFields("Points", _pointsControllers, _addPointField, _removePointField, minFields: 3),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        List<String> rules = _rulesControllers
                            ...
                            .where((text) => text.isNotEmpty) // Filter out empty rules
                            .toList();
                        ...
                        signupController.createEventInfo(
                          ...
                          rules: rules,
                          maxStudents: int.tryParse(_maxStudentsController.text) ?? 1,
                          minStudents: int.tryParse(_minStudentsController.text) ?? 1,
  ...
  Widget _buildDynamicFields(String label, List<TextEditingController> controllers, VoidCallback addField, VoidCallback removeField, {int minFields = 0}) {
    return Column(
