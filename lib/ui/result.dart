...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Future<void> fetchLeaderboard() async {
    ...
    try {
      ...
      tableData.sort((a, b) => (b['totalPoints'] as num).compareTo(a['totalPoints'] as num));
  ...
  Widget _buildResponsiveChart() {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        double availableWidth = constraints.maxWidth - 20; // Accounting for padding

        // Calculate if scrolling is needed
        bool needsScrolling = tableData.length > initialVisibleBars;
        double minBarWidth = 85; // Increased width per bar to accommodate labels
        double chartWidth = needsScrolling
            ? tableData.length * minBarWidth
            : availableWidth;
    ...
    return BarChart(
      BarChartData(
        ...
        barGroups: tableData.asMap().entries.map((entry) {
          ...
          List<Color> colors = index < 3
              ? topWinnerColors[index]
              : barGradientColors;
            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (double value, TitleMeta meta) {
                if (value.toInt() >= 0 && value.toInt() < tableData.length) {
                  ...
                  String shortName = tableData[value.toInt()]['name'].toString();
                  ...
                  return SizedBox(
                    height: 42, // Explicitly set a sufficient height to avoid overflow
                    child: Column(
                      mainAxisSize: MainAxisSize.min, // This isn't enough alone
                      mainAxisAlignment: MainAxisAlignment.start, // Align to top to avoid overflow
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: isTopThree ? topWinnerColors[value.toInt()][0] : Colors.grey[300],
                            shape: BoxShape.circle,
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: isTopThree ? topWinnerColors[index][0] : Colors.grey.shade300,
              boxShadow: isTopThree
                  ? [
                BoxShadow(
